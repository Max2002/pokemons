...
=======
    ...
    // const [clickPokemon, setClickPokemon] = useState(false);
    // const [idDidClickPokemon, setIdDidClickPokemon] = useState(null);
    // const [state, setState] = useState({
    //     clickPokemon: false,
    //     idDidClickPokemon: null
    //     // gender: {},
    ...
    useEffect(async () => {
        setPokemons(await api(50));
    }, []);
>>>>>>> Stashed changes

    // async componentDidMount() {
    //     // this.setState({
    //     //     pokemons: await pokemons(20)
    //     // });
...
=======
    return (
        <div>
            <Header onClick = {() => searchPokemon()} />
            <div className="main">
                <div className="container">
                    {!state.clickPokemon ? <Main pokemons = {pokemons}
                                                 clickPokemon = {clickPokemon.bind(this)} /> :
